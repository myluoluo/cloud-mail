const zh = {
    ...
    webhookDesc: '收件成功后通过队列异步回调到指定地址',
    webhookUrl: 'Webhook URL',
    webhookSecret: 'Webhook Secret',
    clearWebhookSecret: '清空已保存 Secret',
    webhookUrlRequiredMsg: '启用 Webhook 时必须填写 Webhook URL',
    webhookSecretRequiredMsg: '启用 Webhook 时必须保留或填写 Webhook Secret',
    webhookUrlErrorMsg: 'Webhook URL 不正确',
