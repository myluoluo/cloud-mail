const en = {
    ...
    webhookDesc: 'Asynchronously callback the full email notification after successful receive',
    webhookUrl: 'Webhook URL',
    webhookSecret: 'Webhook Secret',
    clearWebhookSecret: 'Clear saved secret',
    webhookUrlRequiredMsg: 'Webhook URL is required when Webhook is enabled',
    webhookSecretRequiredMsg: 'Webhook secret is required when Webhook is enabled',
    webhookUrlErrorMsg: 'Invalid webhook URL',
